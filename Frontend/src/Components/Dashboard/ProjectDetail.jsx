    ...
    <div className="p-6 text-white max-w-7xl mx-auto">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              {tasksNotStarted.length > 0 ? (
                tasksNotStarted.map((task) => (
                  <TaskCard key={task.id} task={task} onTaskUpdate={fetchData} members={members} />
                ))
              ) : (
          ...
          {/* In Progress */}
          <div className="bg-gray-900/50 p-4 rounded-lg">
            <h3 className="font-bold text-lg mb-4 text-center text-blue-400">
          ...
          {/* Completed */}
          <div className="bg-gray-900/50 p-4 rounded-lg">
            <h3 className="font-bold text-lg mb-4 text-center text-green-500">
      ...
      {/* Komentar */}
      <div className="mt-10">
        <h2 className="text-2xl font-semibold mb-4">Komentar Proyek</h2>
